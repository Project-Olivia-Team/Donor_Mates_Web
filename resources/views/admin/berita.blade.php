...
<script>
    function openEditModal(beritaId) {
        // Mengambil data berita dengan AJAX
        $.ajax({
            url: '/admin/berita/' + beritaId + '/edit',
            method: 'GET',
            success: function(data) {
                // Mengisi nilai modal dengan data berita yang diambil
                $('#editBeritaForm').attr('action', '/admin/berita/' + beritaId);  // Set the action URL
