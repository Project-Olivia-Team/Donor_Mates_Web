...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('user/css/merchandise.css') }}">
...
<body>
    ...
    <div class="hero-section">
        <div class="content">
            ...
            <div class="search-bar">
                <form action="{{ route('user.merchandise.search') }}" method="GET">
                    <input style="width: 500px" type="text" name="query" placeholder="Cari produk..." value="{{ request()->input('query') }}" />
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-4 mt-5  d-flex justify-content-center">
                <a href="{{ route('user.detailproduk', $merchandise->merchandise_id) }}" class="card-link">
